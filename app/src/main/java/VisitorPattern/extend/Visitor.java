...
import VisitorPattern.advance.CommonEmployee;
import VisitorPattern.advance.Employee;
import VisitorPattern.advance.Manager;
...
public class Visitor implements IVisitor {
    ...
    // 访问普通员工，打印出报表
    public void visit(VisitorPattern.advance.CommonEmployee commonEmployee) {
    ...
    // 访问部门经理，打印出报表
    public void visit(VisitorPattern.advance.Manager manager) {
